// Background script for Bookmark Lister extension
// Implements Chrome Side Panel API based on official documentation
import { initializeServices } from './src/lib/services/serviceInitializer.js';

// Initialize services (but don't use them here - just make them available)
initializeServices();
