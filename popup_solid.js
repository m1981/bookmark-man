...
import ChromeBookmarkRepository from './src/lib/repositories/ChromeBookmarkRepository.js';
import ChromeBookmarkTransactionManager from './src/lib/services/ChromeBookmarkTransactionManager.js';
import BookmarkOperationExecutor from './src/lib/services/BookmarkOperationExecutor.js';
import DOMUIService from './src/lib/services/DOMUIService.js';

// Initialize services
const bookmarkRepository = new ChromeBookmarkRepository(chrome);
const transactionManager = new ChromeBookmarkTransactionManager(bookmarkRepository, chrome);
const operationExecutor = new BookmarkOperationExecutor(bookmarkRepository);
const restructuringService = new BookmarkRestructuringService(
  bookmarkRepository, 
  transactionManager,
  operationExecutor
);
